...
const content = {
  vi: {
    ...
    intro:
      'Chúng tôi tiếp cận các hãng sản xuất camera và thiết bị giám sát với vị thế đối tác giải pháp (Solution Partner): vừa phát triển phần mềm trên nền tảng của hãng, vừa tích hợp và cung cấp thiết bị cho dự án trọn gói tại Việt Nam. Đây không phải một thoả thuận đã ký — đây là hướng đi chúng tôi theo đuổi một cách nhất quán, và trang này trình bày cụ thể những gì chúng tôi mang lại cho hãng khi hai bên làm việc cùng nhau.',
    ...
    values: [
      {
        ...
        body: 'Mỗi bài toán nghiệp vụ chúng tôi giải trực tiếp trên camera của hãng — đếm hàng, phát hiện vi phạm bảo hộ, trích xuất bằng chứng theo mốc thời gian — là một lý do cụ thể để khách hàng doanh nghiệp chọn thiết bị đó thay vì một thiết bị rẻ hơn không có lớp phần mềm đi kèm. Giá trị phần cứng không còn nằm ở thông số kỹ thuật, mà ở bài toán nó giải được ngay khi lắp đặt.',
      },
      {
        title: 'Chúng tôi sống bằng doanh thu định kỳ, nên chúng tôi có lý do để ở lại.',
        body: 'Mô hình kinh doanh của chúng tôi là phần mềm thuê theo chu kỳ (tháng/quý/năm) kết hợp cung cấp thiết bị, không phải một dự án bàn giao rồi rút như gia công truyền thống. Khách hàng còn dùng hệ thống thì chúng tôi còn phải bảo trì và cải tiến — nghĩa là chúng tôi có động lực tài chính trực tiếp để vẫn còn đó và vận hành tốt sau 3 năm, không chỉ sau lễ nghiệm thu.',
      },
      {
        title: 'Đội kỹ thuật là người của chúng tôi, không phải bên thứ ba.',
        body: 'Kiến trúc hệ thống, mô hình AI và lớp tích hợp thiết bị đều do đội kỹ thuật nội bộ thiết kế và chịu trách nhiệm trực tiếp, không gia công lại qua một bên thứ ba trung gian. Khi hãng cần trao đổi kỹ thuật sâu — về API, về hiệu năng suy luận, về cách chúng tôi dùng luồng hình — người trả lời chính là người đã viết code, không phải người chuyển tiếp câu hỏi.',
      },
    ] satisfies ValueProp[],
    ...
    forms: [
      ...
      {
        icon: Cpu,
        title: 'Đồng phát triển AI tại biên chạy trực tiếp trên camera',
        body: 'Đưa mô hình phát hiện chạy trực tiếp trên phần cứng của hãng thông qua nền tảng phát triển tại biên (ACAP hoặc tương đương) — giảm băng thông, giữ dữ liệu tại chỗ, và biến camera thành một thiết bị suy luận độc lập.',
  ...
  en: {
    ...
    values: [
      {
        ...
        body: 'Every business problem we solve directly on the manufacturer’s camera — counting goods, detecting PPE violations, pulling timestamped evidence — is a concrete reason for a business customer to choose that device over a cheaper one with no software layer attached. The hardware’s value stops being about spec sheets and starts being about the problem it solves the moment it’s installed.',
      },
      {
        title: 'We live on recurring revenue, so we have a reason to stay.',
        body: 'Our business model is subscription software (monthly/quarterly/annual) bundled with hardware, not a one-off project delivered and walked away from like traditional outsourcing. As long as a customer is running the system, we still have to maintain and improve it — meaning we have a direct financial incentive to still be there, working properly, three years in, not just at sign-off.',
      },
      {
        title: 'The engineering team is ours, not a subcontractor’s.',
        body: 'System architecture, the AI models, and the device-integration layer are all designed and owned directly by our in-house engineering team, not handed off to a third party. When a manufacturer needs a deep technical conversation — about the API, about inference performance, about how we use the video stream — the person answering is the person who wrote the code, not someone relaying the question.',
      },
    ] satisfies ValueProp[],
    ...
    forms: [
      ...
      {
        icon: Cpu,
        title: 'Co-developing edge AI that runs directly on the camera',
        body: 'Running detection models directly on the manufacturer’s hardware through their edge development platform (ACAP or equivalent) — cutting bandwidth, keeping data on-site, and turning the camera into a standalone inference device.',
        tag: 'roadmap' as Status,
      },
    ] satisfies CooperationForm[],
    ...
    deviceRows: [
      ...
      },
      {
        ...
        interfaces: 'ACAP',
        status: 'roadmap',
        note: 'Running detection models directly on the camera. A proposed technical partnership goal with the vendor.',
      },
      {
        device: 'Hikvision',
        interfaces: 'ISAPI · SDK',
      ...
      },
      {
        ...
        status: 'roadmap',
        note: 'Part of phase 2 of the VOMA platform.',
      },
    ] satisfies DeviceRow[],
  ...
  sv: {
    ...
    intro:
      'Vi närmar oss tillverkare av kamera- och övervakningshårdvara som en lösningspartner (Solution Partner): vi utvecklar programvara på tillverkarens plattform, och integrerar samt levererar deras hårdvara i nyckelfärdiga projekt i Vietnam. Det här är inte ett undertecknat avtal — det är den riktning vi konsekvent driver, och den här sidan beskriver konkret vad vi tillför en tillverkare när vi samarbetar.',
    ...
    values: [
      {
        ...
        body: 'Varje affärsproblem vi löser direkt på tillverkarens kamera — lagerräkning, upptäckt av bristande skyddsutrustning, tidsstämplade bevis — är ett konkret skäl för en företagskund att välja just den enheten framför en billigare utan tillhörande mjukvarulager. Hårdvarans värde handlar då inte längre om specifikationer, utan om vilket problem den löser direkt vid installation.',
      },
      {
        title: 'Vi lever på återkommande intäkter, så vi har ett skäl att stanna.',
        body: 'Vår affärsmodell bygger på abonnemangsbaserad programvara (månads-, kvartals- eller årsvis) kombinerad med hårdvaruleverans, inte ett enskilt projekt som levereras och sedan lämnas därhän som traditionell konsultutveckling. Så länge en kund använder systemet måste vi fortsätta underhålla och förbättra det — det ger oss ett direkt ekonomiskt incitament att fortfarande finnas där och fungera väl efter tre år, inte bara vid slutbesiktningen.',
      },
      {
        title: 'Utvecklingsteamet är vårt eget, inte en underleverantörs.',
        body: 'Systemarkitektur, AI-modeller och integrationslagret för hårdvaran designas och ägs direkt av vårt interna utvecklingsteam, utan att läggas ut på en tredje part. När en tillverkare behöver en djupare teknisk diskussion — om API:et, om inferensprestanda, om hur vi hanterar videoströmmen — är det samma person som skrivit koden som svarar, inte någon som vidarebefordrar frågan.',
      },
    ] satisfies ValueProp[],
    ...
    forms: [
      ...
      {
        icon: Cpu,
        title: 'Samutveckling av edge-AI som körs direkt på kameran',
        body: 'Att köra detekteringsmodeller direkt på tillverkarens hårdvara via deras utvecklingsplattform för edge (ACAP eller motsvarande) — vilket minskar bandbreddsbehovet, håller data på plats och gör kameran till en fristående inferensenhet.',
        tag: 'roadmap' as Status,
      },
    ] satisfies CooperationForm[],
    ...
    deviceRows: [
      ...
      },
      {
        ...
        interfaces: 'ACAP',
        status: 'roadmap',
        note: 'Att köra detekteringsmodeller direkt på kameran. Ett föreslaget tekniskt samarbetsmål med tillverkaren.',
      },
      {
        device: 'Hikvision',
        interfaces: 'ISAPI · SDK',
      ...
      },
      {
        ...
        status: 'roadmap',
        note: 'Del av fas 2 i VOMA-plattformen.',
      },
    ] satisfies DeviceRow[],
