...
const content = {
  vi: {
    ...
    vomaBody: 'Nền tảng bán hàng đa kênh và quản trị toàn diện — hoá đơn điện tử, bán hàng online/offline, kế toán, kho bãi. Đã đăng ký bảo hộ nhãn hiệu độc quyền tại Việt Nam.',
  ...
  en: {
    ...
    vomaBody: 'A multichannel sales and full-scale management platform — e-invoicing, online/offline sales, accounting, warehousing. Trademark-registered in Vietnam.',
  ...
  sv: {
    ...
    vomaBody: 'En plattform för multikanalförsäljning och komplett verksamhetsstyrning — e-fakturering, online-/offlineförsäljning, bokföring, lagerhantering. Varumärkesregistrerad i Vietnam.',
